...
<%
     ...
     AdministrationServiceService ts = new AdministrationServiceServiceLocator(host, port, path, secure);
     ...
     AdministrationServiceClient asc = new AdministrationServiceClient(host, port, Username, Password, AdminLocation,secure);
     ReportServiceClient rsc = new ReportServiceClient(host, port,  Username, Password, ReportLocation,secure);
	 ...
	 String url = "http://localhost:8080/SS0.jsp";
...
<nav style="height:80; margin:0; float:left; padding-left:25;">
	<ul>
		<li> <a href="http://localhost:8080/ws_reportEmbed.jsp"> Home </a> </li>
		<li> <a href="#"> Reports </a>
			<ul>
				<%	String url = "http://localhost:8080/ws_reportEmbed.jsp";
				...
				<%	url = "http://localhost:8080/ws_reportEmbed.jsp";
					if (!request.isRequestedSessionIdFromCookie() && request.getSession().getId() != null) url += ";jsessionid=" + request.getSession().getId();
		...
		<li> <a href="http://localhost:8080/ws_reportEmbed.jsp"> News Feed </a> </li>
		<li> <a href="http://localhost:8080/ws_reportEmbed.jsp"> My Profile </a> </li>
		<li> <a href="http://localhost:8080/ws_reportEmbed.jsp"> Settings </a> </li>
		<li> <a href="http://localhost:8080/demo.html"> Log off </a> </li>
	</ul>
</nav>
<br><br><br><br>
